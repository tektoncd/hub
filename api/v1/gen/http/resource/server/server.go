...
type Server struct {
	...
	ByID                                 http.Handler
	ByCatalogKindNameAndPipelinesVersion http.Handler
	CORS                                 http.Handler
}
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"ByCatalogKindNameAndPipelinesVersion", "GET", "/v1/resource/{catalog}/{kind}/{name}/pipelinesversion/{pipelinesVersion}"},
			...
			{"CORS", "OPTIONS", "/v1/resource/{catalog}/{kind}/{name}/pipelinesversion/{pipelinesVersion}"},
		},
		...
		ByCatalogKindNameAndPipelinesVersion: NewByCatalogKindNameAndPipelinesVersionHandler(e.ByCatalogKindNameAndPipelinesVersion, mux, decoder, encoder, errhandler, formatter),
		CORS:                                 NewCORSHandler(),
	}
}
...
func (s *Server) Use(m func(http.Handler) http.Handler) {
	...
	s.ByID = m(s.ByID)
	s.ByCatalogKindNameAndPipelinesVersion = m(s.ByCatalogKindNameAndPipelinesVersion)
	s.CORS = m(s.CORS)
}
...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountByCatalogKindNameAndPipelinesVersionHandler(mux, h.ByCatalogKindNameAndPipelinesVersion)
...
// MountByCatalogKindNameAndPipelinesVersionHandler configures the mux to serve
// the "resource" service "ByCatalogKindNameAndPipelinesVersion" endpoint.
func MountByCatalogKindNameAndPipelinesVersionHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := handleResourceOrigin(h).(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/v1/resource/{catalog}/{kind}/{name}/pipelinesversion/{pipelinesVersion}", f)
}

// NewByCatalogKindNameAndPipelinesVersionHandler creates a HTTP handler which
// loads the HTTP request and calls the "resource" service
// "ByCatalogKindNameAndPipelinesVersion" endpoint.
func NewByCatalogKindNameAndPipelinesVersionHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeByCatalogKindNameAndPipelinesVersionRequest(mux, decoder)
		encodeResponse = EncodeByCatalogKindNameAndPipelinesVersionResponse(encoder)
		encodeError    = EncodeByCatalogKindNameAndPipelinesVersionError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "ByCatalogKindNameAndPipelinesVersion")
		ctx = context.WithValue(ctx, goa.ServiceKey, "resource")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil {
...
func MountCORSHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("OPTIONS", "/v1/resource/{catalog}/{kind}/{name}/pipelinesversion/{pipelinesVersion}", f)
}
