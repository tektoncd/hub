...
// CatalogErrorsView is a type that runs validations on a projected type.
type CatalogErrorsView struct {
	// Catalog Errror type
	Type *string
...
// ValidateCatalogErrorsView runs the validations defined on CatalogErrorsView.
func ValidateCatalogErrorsView(result *CatalogErrorsView) (err error) {
	if result.Type == nil {
