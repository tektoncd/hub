...
Example:
    %[1]s catalog refresh --catalog-name "tekton" --token "Dicta sunt fugiat sequi."
`, os.Args[0])
}
...
Example:
    %[1]s catalog refresh-all --token "Eveniet perspiciatis ut ut debitis."
`, os.Args[0])
}
...
Example:
    %[1]s rating get --id 10742999385231993405 --token "Voluptatem cum sed."
`, os.Args[0])
}
