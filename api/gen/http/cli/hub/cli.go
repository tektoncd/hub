...
func UsageExamples() string {
	return os.Args[0] + ` admin update-agent --body '{
      ...
      "scopes": [
		...
		os.Args[0] + ` catalog refresh --catalog-name "tekton" --token "Autem dolores at."` + "\n" +
		os.Args[0] + ` category list` + "\n" +
		os.Args[0] + ` rating get --id 7653918363870584827 --token "Ab beatae est magnam eveniet nihil et."` + "\n" +
...
Example:
    %[1]s catalog refresh --catalog-name "tekton" --token "Autem dolores at."
`, os.Args[0])
}
...
Example:
    %[1]s catalog refresh-all --token "Ut pariatur similique ullam laudantium nostrum quia."
`, os.Args[0])
}
...
Example:
    %[1]s rating get --id 7653918363870584827 --token "Ab beatae est magnam eveniet nihil et."
`, os.Args[0])
}
...
Example:
    %[1]s rating update --body '{
      "rating": 0
   }' --id 9213177221109120328 --token "Accusantium aut iste."
`, os.Args[0])
}
