    ...
    <React.Fragment>
      ...
      >
        <Grid>
          <TextContent>
            <TextList>
              <TextListItem>Press `/` in keyboard to quick focus on search</TextListItem>
              <TextListItem>It searches resources by its name,displayName or tags</TextListItem>
              <TextListItem>
                Use specific format to search resources by tags e.g. `tags:tagA,tagB`
              </TextListItem>
            </TextList>
          </TextContent>
        </Grid>
